...
const Banner = () => {
  return (
    <div className="bg-green-500 p-3 flex items-center mb-10 bg-banner bg-no-repeat bg-cover justify-evenly">
      <img src={mower} alt="" className="w-[200px] hidden sm:flex" />
      <div className="flex flex-col justify-start items-start  gap-2">
        <h1 className="text-2xl md:text-4xl font-bold text-white lg:w-[80%] md:w-[100%] ">
