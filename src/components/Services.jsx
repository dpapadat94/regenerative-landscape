...
const Services = () => {
  return (
    <div className="w-fit h-fit pt-5  flex flex-col gap-1 justify-center items-center bg-[#fff]  mx-auto px-2 ">
      <h1 className=" text-3xl sm:text-4xl font-bold text-gray-600 p-3 justify-center border-b-4 border-green-500 ">
        Landscaping Services
      </h1>
      <IndividualServices />

      <h1 className="text-gray-600 text-3xl sm:text-4xl font-bold  pb-3 border-b-4 border-green-500  ">
        Lawn Care Packages
      </h1>
